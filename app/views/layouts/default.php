                ...
                <?php else : ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                            <?= $this->e(\App\SessionGuard::TaiKhoan()->tennv) ?> <span class="caret"></span>
                        </a>
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="/AddNewAccount" style="display: <?= (\App\SessionGuard::TaiKhoan()->role == 1) ? 'block' : 'none' ?>;">
                                    add new account
                            </a>
                            <!-- <form id="AddAccount-form" class="d-none" action="/AddAccount" method="GET"> -->
                            </form>
                        </div>
                    </li>
                <?php endif ?>
